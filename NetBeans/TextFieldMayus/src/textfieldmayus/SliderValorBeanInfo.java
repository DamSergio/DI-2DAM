...
public class SliderValorBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_paintLabels = 86;
    private static final int PROPERTY_paintTicks = 87;
    private static final int PROPERTY_paintTrack = 88;
    ...
    private static final int PROPERTY_valorLabel = 110;
    private static final int PROPERTY_value = 111;
    private static final int PROPERTY_valueIsAdjusting = 112;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", textfieldmayus.SliderValor.class, null, "setMixingCutoutShape" ); // NOI18N
            ...
            properties[PROPERTY_valorActualVisible].setPreferred ( true );
            properties[PROPERTY_valores] = new PropertyDescriptor ( "valores", textfieldmayus.SliderValor.class, "getValores", "setValores" ); // NOI18N
            properties[PROPERTY_valores].setPreferred ( true );
            properties[PROPERTY_valores].setPropertyEditorClass ( textfieldmayus.ValoresPropertyEditor.class );
            properties[PROPERTY_valorLabel] = new PropertyDescriptor ( "valorLabel", textfieldmayus.SliderValor.class, "getValorLabel", "setValorLabel" ); // NOI18N
    ...
    private static final int METHOD_actualizarValores1 = 1;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_actualizarValores1] = new MethodDescriptor(textfieldmayus.SliderValor.class.getMethod("actualizarValores", new Class[] {})); // NOI18N
            methods[METHOD_actualizarValores1].setDisplayName ( "" );
